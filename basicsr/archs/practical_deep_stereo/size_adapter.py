...
class SizeAdapter(object):
    ...
    def pad(self, network_input):
        ...
        return nn.ZeroPad2d((0, self._pixels_pad_to_width, 0,
                             self._pixels_pad_to_height))(network_input)
    ...
    def unpad(self, network_output):
        ...
        if self._pixels_pad_to_height == 0:
            return network_output[..., :, :-self._pixels_pad_to_width]
        if self._pixels_pad_to_width == 0:
            return network_output[..., :-self._pixels_pad_to_height, :]
